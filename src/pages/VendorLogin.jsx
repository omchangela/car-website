...
const VendorLogin = () => {
    return (
        <>
            <LoginNavbar />
            <div className="flex items-center bg-white justify-center min-h-screen bg-gray-50 py-8">
                {/* Container to hold both Ciao and Form */}
                        ...
                        <form>
                            ...
                            <div className="text-center">
                                <p className="text-sm text-gray-600">
                                    ...
                                    <a href="/vendorsignup" className="text-red-500 hover:underline">
                                        Register Now
                                    </a>
                                </p>
                            </div>
